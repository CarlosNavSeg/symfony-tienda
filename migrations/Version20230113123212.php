 ...
 */
final class Version20230113123212 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item ADD CONSTRAINT FK_52EA1F098A484C35 FOREIGN KEY (order_items_id) REFERENCES `order` (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
