 ...
 */
final class Version20230113120139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993988A484C35 FOREIGN KEY (order_items_id) REFERENCES order_item (id)');
